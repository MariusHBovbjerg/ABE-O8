...
namespace Consumer
{
    public static class Receive
    {
        ...
        private const string RoutingKey = "HotelWestKey";
        ...
        public static void Main()
        {
            ...
            consumer.Received += (_, ea) =>
            {
                ...
                try
                {
                    ...
                    {
                        HotelBookingCmd.Type => cmd.Location == Location.WEST ? "HotelWestBooked" : "HotelWestFailed",
                        
                        HotelCancelCmd.Type => "HotelWestCancelled",
                        _ => "False"
                    };
                }
                catch (Exception e)
